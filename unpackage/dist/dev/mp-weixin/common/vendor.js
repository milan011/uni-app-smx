...
/***/ 113:
/*!****************************************!*\
  !*** F:/vue-obj/mix-mall/api/login.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.loginByUser = loginByUser;var _config = _interopRequireDefault(__webpack_require__(/*! @/common/config.js */ 20));

var _index = __webpack_require__(/*! @/js_sdk/luch-request/index.js */ 31);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} // import uniRequest from 'uni-request'
...
function loginByUser() {
  ...
  var data = { username: 'wcg', password: '111111' };
  var requestUrl = _config.default + 'login';
  return _index.http.post('http://www.mycnc.net/login', data)
  /*.then(res => {})
                                                              .catch(err => {})*/;
}
...
/***/ 20:
/*!********************************************!*\
  !*** F:/vue-obj/mix-mall/common/config.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//变速箱
var transmissionConfig = ['不限', '手动', '自动'];var _default =

{
  url_config: url_config,
  transmissionConfig: transmissionConfig };exports.default = _default;

/***/ }),

/***/ 224:
/*!*********************************************************!*\
  !*** F:/vue-obj/mix-mall/components/uni-icons/icons.js ***!
  \*********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 30:
/*!******************************************!*\
  !*** F:/vue-obj/mix-mall/api/example.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getExampleList = getExampleList;
...
function getExampleList() {
  /*const query = { data: {id: '23'} }
                           const data = { id: '222' }*/
  // return uniRequest.get(urlConfig + '/user?id=12345')
  return _index.httpApi.get('http://www.mycnc.net/list', { params: { id: '111' } })
  /*.then(res => {})
                                                                                    .catch(err => {})*/;
}
...
/***/ 31:
/*!********************************************************!*\
  !*** F:/vue-obj/mix-mall/js_sdk/luch-request/index.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.http = exports.httpApi = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! ./request */ 32));
...
var httpApi = new _request.default();exports.httpApi = httpApi;

httpApi.setConfig(function (config) {/* 设置全局配置 */
...
/**
     ...
     * @return { Boolean } 如果为true,则 resolve, 否则 reject
     */
httpApi.validateStatus = function (statusCode) {
  return statusCode === 200;
};

httpApi.interceptor.request(function (config, cancel) {/* 请求之前拦截器 */
  config.header = _objectSpread({},
  config.header);


  console.log('store', _store.default.state);

  if (!_store.default.state.userInfo.token) {// 如果token不存在，调用cancel 会取消本次请求，但是该函数的catch() 仍会执行
    alert('token none');
    cancel('token 不存在'); // 接收一个参数，会传给catch((err) => {}) err.errMsg === 'token 不存在'
  }
...
httpApi.interceptor.response(function (response) {/* 请求之后拦截器 */
...
/***/ 32:
/*!**********************************************************!*\
  !*** F:/vue-obj/mix-mall/js_sdk/luch-request/request.js ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 349:
/*!*********************************************************************!*\
  !*** F:/vue-obj/mix-mall/components/uni-swipe-action-item/mpwxs.js ***!
  \*********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 7:
/*!*******************************************************!*\
  !*** F:/vue-obj/mix-mall/pages.json?{"type":"style"} ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "usingComponents": {}, "usingAutoImportComponents": { "uni-nav-bar": "/components/uni-nav-bar/uni-nav-bar", "uni-search-bar": "/components/uni-search-bar/uni-search-bar" } }, "pages/search/search": { "usingComponents": {}, "usingAutoImportComponents": { "uni-nav-bar": "/components/uni-nav-bar/uni-nav-bar", "uni-search-bar": "/components/uni-search-bar/uni-search-bar", "uni-list": "/components/uni-list/uni-list", "uni-list-item": "/components/uni-list-item/uni-list-item" } }, "pages/product/product": { "usingComponents": { "share": "/components/share", "uni-segmented-control": "/components/uni-segmented-control/uni-segmented-control", "list-cell": "/components/mix-list-cell", "status-car": "/pages/product/components/status-car", "vin-car": "/pages/product/components/vin-car" }, "usingAutoImportComponents": { "uni-segmented-control": "/components/uni-segmented-control/uni-segmented-control" } }, "pages/set/set": { "navigationBarTitleText": "设置", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/userinfo/userinfo": { "navigationBarTitleText": "修改资料", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/cart/cart": { "navigationBarTitleText": "购物车", "usingComponents": { "uni-number-box": "/components/uni-number-box" }, "usingAutoImportComponents": {} }, "pages/public/login": { "navigationBarTitleText": "", "navigationStyle": "custom", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/user/user": { "navigationBarTitleText": "我的", "usingComponents": { "list-cell": "/components/mix-list-cell" }, "usingAutoImportComponents": {} }, "pages/detail/detail": { "navigationBarTitleText": "", "usingComponents": { "share": "/components/share" }, "usingAutoImportComponents": {} }, "pages/order/order": { "navigationBarTitleText": "我的订单", "usingComponents": { "uni-load-more": "/components/uni-load-more/uni-load-more", "empty": "/components/empty" }, "usingAutoImportComponents": { "uni-load-more": "/components/uni-load-more/uni-load-more" } }, "pages/money/money": { "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/order/createOrder": { "navigationBarTitleText": "创建订单", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/address/address": { "navigationBarTitleText": "收货地址", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/address/addressManage": { "navigationBarTitleText": "", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/money/pay": { "navigationBarTitleText": "支付", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/money/paySuccess": { "navigationBarTitleText": "支付成功", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/notice/notice": { "navigationStyle": "custom", "navigationBarTitleText": "通知", "usingComponents": { "uni-nav-bar": "/components/uni-nav-bar/uni-nav-bar", "uni-icons": "/components/uni-icons/uni-icons" }, "usingAutoImportComponents": { "uni-nav-bar": "/components/uni-nav-bar/uni-nav-bar" } }, "pages/category/category": { "navigationBarTitleText": "分类", "usingComponents": {}, "usingAutoImportComponents": {} }, "pages/product/list": { "enablePullDownRefresh": true, "navigationBarTitleText": "车源列表", "usingComponents": { "uni-load-more": "/components/uni-load-more/uni-load-more", "h-mfilter-dropdown": "/components/HM-filterDropdown/HM-filterDropdown" }, "usingAutoImportComponents": { "uni-load-more": "/components/uni-load-more/uni-load-more" } }, "pages/car/list": { "navigationBarTitleText": "车源管理" } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "驷马先二手车电商平台", "navigationBarBackgroundColor": "#FFFFFF", "backgroundColor": "#f8f8f8" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!******************************************************!*\
  !*** F:/vue-obj/mix-mall/pages.json?{"type":"stat"} ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__B1D7D68" };exports.default = _default;

/***/ }),

/***/ 9:
/*!******************************************!*\
  !*** F:/vue-obj/mix-mall/store/index.js ***!
  \******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
