<template>
	<view>
		<uni-nav-bar @clickLeft="returss" left-text="石家庄" left-icon="location-filled" right-text="菜单" class="mystyle"  title="这是自定义通知">
		</uni-nav-bar>
...
<style>
	.mystyle /deep/ .uni-navbar__header-btns-left{
		width:95px;
	}
</style>
<style lang='scss'>
